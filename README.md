...
2) In the first terminal run both of these commands:
  ...
  &emsp;source /opt/ros/humble/setup.bash</br>
  &emsp;ros2 run turtlesim turtlesim_node</br>


3) In the second terminal run these commands:

  &emsp;source /opt/ros/humble/setup.bash</br>
  &emsp;colcon build __symlink-install --packages-select hw1</br>
  &emsp;source ~/ros2_ws/install/setup.bash</br>
  &emsp;ros2 run hw1 <file></br>
  &emsp;Ex: ros2 run hw1 circle
